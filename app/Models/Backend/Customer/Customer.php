...
class Customer extends Model
{
    ...
    protected $fillable = [
        'ledger_page_no','customer_type_id','branch_id','custom_id','name','email','email_verified_at','password','gender','phone','phone_2','blood_group','religion','unique_id_no','company_name','address','previous_due_date','next_payment_date','note','verified','deleted_at','verified_by','created_by',
        ...
        'current_paid_return','current_total_due','current_total_advance','current_total_loan','current_total_return','total_due','total_advance','total_loan','total_return','current_total_sell_amount','current_total_sell_reference_amount','current_total_sell_profit_amount','total_sell_amount','total_sell_reference_amount','total_sell_profit_amount','total_discount_amount',
    ];
