   ...
   function displaySellCreateAddedToCartProductList()
   {
    ...
    // add to sale edit cart [submit]
    jQuery(document).on("submit",'.addToSellEditCart',function(e){
        e.preventDefault();
    ...
    //confirmation popup - remove/delete single item from edit sell cart product stock item
    jQuery(document).on('click','.remove_this_edit_sell_cart_product_stock_item',function(e){
        e.preventDefault();
        var edit_sell_cart_product_stock_id = jQuery(this).data('edit_sell_cart_product_stock_id');
        var url = jQuery('.removeConfirmationRequiredSingleItemFromSellAddedToCartListUrl').val();
        jQuery.ajax({
            url:url,
            data:{edit_sell_cart_product_stock_id:edit_sell_cart_product_stock_id},
            beforeSend:function(){
                jQuery('.processing').fadeIn();
            },
            success:function(response){
    ...
    //confirmation popup - remove/delete single item from sell cart product list
    jQuery(document).on('click','.remove_this_item_from_sell_cart_list',function(e){
        e.preventDefault();
        var edit_sell_product_id = jQuery(this).data('edit_sell_product_id');
        var url = jQuery('.removeConfirmationRequiredSingleItemFromSellAddedToCartListUrl').val();
        jQuery.ajax({
            url:url,
            data:{edit_sell_product_id:edit_sell_product_id},
            beforeSend:function(){
                jQuery('.processing').fadeIn();
            },
            success:function(response){
    ...
    //removing single item from edit sell cart product
    jQuery(document).on('click','.removeSingleItemFromEditSellCartProductList',function(){

        var totalCartItem = nanCheck(parseFloat(jQuery('.totalItemFromSellCartList').text()));

        var remove_edit_sell_cart_product_id = jQuery('.remove_edit_sell_cart_product_id').val();
        var url = jQuery('.removeSingleItemFromSellAddedToCartListUrl').val();
        jQuery.ajax({
            url:url,
            data:{remove_edit_sell_cart_product_id:remove_edit_sell_cart_product_id},
            beforeSend:function(){
                jQuery('.processing').fadeIn();
            },
            success:function(response){
    ...
    //removing/delete single item from edit sell cart product stock item
    jQuery(document).on('click','.removeSingleItemFromEditSellCartProductStockList',function(){
        
        var totalCartItem = nanCheck(parseFloat(jQuery('.totalItemFromSellCartList').text()));
    
        var remove_edit_sell_cart_product_stock_id = jQuery('.remove_edit_sell_cart_product_stock_id').val();
        var url = jQuery('.removeSingleItemFromSellAddedToCartListUrl').val();
        jQuery.ajax({
            url:url,
            data:{remove_edit_sell_cart_product_stock_id:remove_edit_sell_cart_product_stock_id},
            beforeSend:function(){
                jQuery('.processing').fadeIn();
            },
            success:function(response){
    ...
    //remove/delete single item from edit sell cart product stock item

    //remove/delete : confirmation - all item from sell cart product list 
    ...
    jQuery(document).on('click','.quantityChange',function(e){
        ...
        jQuery.ajax({
            url:url,
            data:{edit_sell_cart_product_stock_id:edit_sell_cart_product_stock_id,change_type:change_type,quantity:quantity},
            beforeSend:function(){
                jQuery('.processing').fadeIn();
            },
            success:function(response){
