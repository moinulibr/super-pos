            ...
            <div class="modal-dialog modal-lg">
                <form action="{{route('admin.customer.store.receive.previous.due')}}" method="POST" class="storeReturnAdvanceAmountDate modal-content">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title">
                            Customer 
                            <span class="font-weight-light">Advance Payment</span>
                            <br />
                        </h5>
                    ...
                    <div class="modal-body" style="margin-left:30px;margin-right:30px;">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label class="col-form-label text-sm-right">Total Advance Amount</label>
