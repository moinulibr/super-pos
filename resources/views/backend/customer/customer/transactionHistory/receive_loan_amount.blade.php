            ...
            <div class="modal-dialog modal-lg">
                <form action="{{route('admin.customer.store.receive.loan.amount')}}" method="POST" class="storeReceiveLoanAmountDate modal-content">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title">
                            Customer 
                            <span class="font-weight-light">Receive Loan</span>
                            <br />
                        </h5>
                    ...
                    <div class="modal-body" style="margin-left:30px;margin-right:30px;">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <label class="col-form-label text-sm-right">Total Loan Amount</label>
