                    ...
                    <td style="width:3%;">
                        <div class="btn-group btnGroupForMoreAction">
                            ...
                            <div class="dropdown-menu " x-placement="top-start" style="position: absolute; will-change: top, left; top: -183px; left: 0px;">
                                ...
                                <a class="dropdown-item singleHistoryModal" data-id="{{$item->id}}" href="{{route('admin.customer.history',$item->id)}}">Transactional Profile</a>
                                <a class="dropdown-item receiveAllInvoiceDuesModal" data-id="{{$item->id}}" href="javascript:void(0)">Receive Invoice All Due</a>
