            ...
            <div class="modal-body">
                                ...
                                <td style="width:24.5%">
                                    <div style="width: 100%;">
                                        ...
                                        <div style="float:right;width:70%;">
                                            <input disabled type="text" style="color:black !important;" class="form-control total_invoice_amount_for_calculator"  value="{{$data->total_payable_amount}}"  placeholder="Invoice Amount">
                                        </div> 
                                    </div> 
                                </td>
                                <td style="width:24.5%">
                                    <div style="width: 100%;">
                                        ...
                                        <div style="float:right;width:70%;">
                                            <input type="text" style="color:black !important;" class="total_paying_amount_for_calculator form-control invoice_paying_amount" disabled placeholder=" Paying Amount">
                                        </div> 
                                    </div> 
                                </td>
                                <td style="width:24.5%">
                ...
                <div class="form-group row justify-content-end mb-0">
                    <div class="col-md-6 text-right">
                        ...
                        <button type="submit" class="btn btn-info submitButton" style="padding:7px 20px;" disabled>
