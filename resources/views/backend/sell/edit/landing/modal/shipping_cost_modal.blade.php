        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{route('admin.sell.edit.regular.pos.customer.shipping.address')}}" class="submitCustomerShippingAddress" id="submitCustomerShippingAddress">
                        @csrf
