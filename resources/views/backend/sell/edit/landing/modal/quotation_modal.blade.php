<div class="modal fade text-left" id="edit-quotation-popup" tabindex="-1" role="dialog" aria-labelledby="myModalLabel11" style="display: none;" aria-hidden="true">
        ...
        <div class="modal-content">
            <form action="{{route('admin.sell.edit.regular.pos.store.data.from.sell.edit.cart')}}" method="POST" class="storeDataFromSellEditCart">
                ...
                <div class="modal-header">
                    <h3 class="modal-title" id="myModalLabel11">Edit Quotation</h3>
                ...
                <div class="modal-body" style="padding-left:50px;padding-right:50px;">
                    ...
                    <div class="form-group row justify-content-end mb-0">
                        <div class="col-md-6 text-right">
                            ...
                            <input type="submit"  class="btn btn-primary" value="Update" style="padding:7px 20px;">
                        </div>
                    </div>
                </div>
            </form>
