            ...
            <div class="modal-dialog modal-xl" >
                ...
                <form action="{{route('admin.sell.edit.regular.pos.store')}}" method="POST" class="addToSellEditCart modal-content">
                    @csrf
                                            ...
                                            <div class=" col-md-7">
                                                <div class="form-group" style="background-color:#6a3d2b;color:#e9ff30;padding:5px;margin-bottom:8px;margin-top:5px;">
                                                    ...
                                                    <div class="selling_from_stock_name_and_selling_product_stock_price_list">
                                                        @include('backend.sell.edit.ajax-response.single-product.include.product_stock_price')
                                                    </div>
                                            ...
                                            <div class="col-md-5">
                                                <div  style="background-color:#6a3d2b;color:#e9ff30;padding:5px;margin-bottom:8px;margin-top:5px;">
                                                    ...
                                                    <div class="form-group" style="margin-bottom:1px;">
                                                        ...
                                                        <input type="hidden" class="displayQuantityWiseSingleProductByProductId" value="{{route('admin.sell.edit.regular.pos.display.quantity.wise.sigle.product.stock.by.product.id')}}">
