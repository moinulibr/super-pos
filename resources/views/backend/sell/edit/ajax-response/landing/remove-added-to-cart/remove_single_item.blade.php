                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body " style="background-color:#ede7e7;"><!-- #e2f7f6; modal body-->
                        ...
                        <div class="form-group" style="text-align: center">
                            ...
                            <input type="hidden" class="remove_edit_sell_cart_product_id" value="{{$edit_sell_product_id}}">
                        </div>
                    ...
                    <div class="modal-footer" style="background-color:#f9f5f4;">
                        ...
                        <strong style="cursor: pointer; padding:6px;" class="removeSingleItemFromEditSellCartProductList btn btn-primary">Yes</strong>
                    </div>
                </div>
            </div>
