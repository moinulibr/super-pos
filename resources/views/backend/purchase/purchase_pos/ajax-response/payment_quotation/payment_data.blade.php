                    ...
                    <td style="width:24.5%">
                        <div style="width: 100%;">
                            ...
                            <div style="float:right;width:70%;">
                                <input disabled type="text"  style="color:black !important;" class="form-control total_invoice_amount_for_calculator"  value="{{$totalPayableAmount}}"  placeholder="Invoice Amount">
                            </div> 
                        </div> 
                    </td>
                    <td style="width:24.5%">
